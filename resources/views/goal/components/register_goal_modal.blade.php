                    ...
                    <div class="box box-info padding-1">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('description', '', ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'placeholder' => 'Description']) }}
                                {!! $errors->first('description', '<div class="invalid-feedback">:message</p>') !!}
                            </div>
                            <div class="form-group">
                                {{ Form::label('Fecha de inicio') }}
                                {{ Form::date('start_date', '', ['class' => 'form-control' . ($errors->has('start_date') ? ' is-invalid' : ''), 'placeholder' => 'Start Date']) }}
                                {!! $errors->first('start_date', '<div class="invalid-feedback">:message</p>') !!}
                            </div>
                            <div class="form-group">
                                {{ Form::label('Fecha límite') }}
                                {{ Form::date('final_date', '', ['class' => 'form-control' . ($errors->has('final_date') ? ' is-invalid' : ''), 'placeholder' => 'Final Date']) }}
                                {!! $errors->first('final_date', '<div class="invalid-feedback">:message</p>') !!}
                            </div>
                            <div class="form-group">
                                {{ Form::label('Cantidad de Meta') }}
                                {{ Form::text('desired_quantity','', ['class' => 'form-control' . ($errors->has('desired_quantity') ? ' is-invalid' : ''), 'placeholder' => 'Desired Quantity']) }}

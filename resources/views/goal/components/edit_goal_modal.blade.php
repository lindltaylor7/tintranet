                ...
                <form method="POST" action="{{ route('goals.update', $goal->id) }}"  role="form" enctype="multipart/form-data">
                    ...
                    <div class="box box-info padding-1">
                        <div class="box-body">                            
                            ...
                            <div class="form-group">
                                {{ Form::label('Unidades') }}
                                {!! Form::select('unit_asigment',['soles'=>'soles','porcentaje'=>'porcentaje','nuemrico'=>'numerico'] , $goal->unit_asigment, ['class' => 'form-control']) !!}
                            ...
                            <div class="form-group">
                                {{ Form::label('Area') }}
                                {!! Form::select('area_id', $areas, $goal->area->id, ['class' => 'form-control']) !!}

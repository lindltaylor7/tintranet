                  ...
                  @foreach ($projects as $project)
                    ...
                    @endif
                     ...
                     <td>
                          <div class="btn-group">
                          <div class="dropdown">
                            <button aria-expanded="false" data-toggle="dropdown" data-boundary="window" class="btn btn-success btn-outline dropdown-toggle " type="button">Tareas<span class="caret"></span></button>

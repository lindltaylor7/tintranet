<div class="modal fade" id="Cliente-remove{{$client->id}}" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          <div class="modal-body modal--padding text-center p-top-40 p-bottom-50">
              ...
              <p class="m-bottom-30 modal__paragraph">¿Deseas eliminar este Cliente?</p>

<div class="modal fade" id="Task-remove{{$task->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body text-center p-top-40 p-bottom-50">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <form action="{{route('tarea.delete',$task->id)}}" method="post">
                        @csrf
                        @method('delete')
                        <button type="submit" class="btn btn-danger">Si, ¡Borrar Tarea!</button>
                    </form>
                </div>
            </div>
        </div>

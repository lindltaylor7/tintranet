...
<head>
    ...
    <!-- select2 CSS -->
    {{-- <link href="{{asset('vendors/bower_components/select2/dist/css/select2.css')}}" rel="stylesheet"
    type="text/css"/> --}}
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#usertable_1').DataTable();
            $('#datable_1').DataTable({
                dom:"<'row'<'col-sm-12 mb-3 mt-5 ml-5 text-center'B>><'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>>" +
                "<'row'<'col-sm-12'tr>>" +
